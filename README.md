...
2. **Segunda Tentativa**: Aumentamos o número de imagens para 200 (positivas e negativas), trocando os exemplos para gatos positivamente e continuando com as imagens do tutorial negativamente, mas novamente não obtivemos sucesso no treinamento do classificador.
